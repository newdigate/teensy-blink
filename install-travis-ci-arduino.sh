...
export MAIN_PLATFORMS='declare -A main_platforms=( [teensy]="teensyduino:avr:teensy36" [zero]="arduino:samd:arduino_zero_native" [m4]="adafruit:samd:adafruit_metro_m4" )'
